...
const sumKey=()=>`msj7-summary::${currentSubject}::${currentStage}`,promptKey=()=>`msj7-prompt::${currentSubject}::${currentStage}`,evKey='msj7-events',fcKey='msj7-flashcards',errKey='msj7-errors';
