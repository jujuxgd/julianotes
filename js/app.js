...
- Paleta fixa e exclusiva desta matéria: ${theme.name}. Use sempre --primary:${theme.primary}; --accent:${theme.accent}; --soft:${theme.soft}; --subject-ink:${theme.ink}; --ink:#211C19; --paper:#FFFFFF; --canvas:#ECE8E3. Não substitua essa cor por outra nas atualizações futuras.
...
- A largura de 210 mm deve existir SOMENTE na impressão. Em @media screen and (max-width:760px), body, capa e páginas devem ter width:100%, max-width:100%, min-width:0, sem zoom, transform ou rolagem horizontal; reduza os paddings para 20–28 px e permita rolagem horizontal apenas nas tabelas.
