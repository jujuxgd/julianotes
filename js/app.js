...
function injectPrintPageRule(doc){if(!doc?.head||doc.querySelector('#journal-print-rule'))return;try{let style=doc.createElement('style');style.id='journal-print-rule';style.textContent='@media print{@page{size:auto;margin:10mm}body,*{-webkit-print-color-adjust:exact;print-color-adjust:exact}.hero{padding:18px 24px!important}.hero h1{font-size:24px!important}.hero .top{font-size:8px!important;margin-bottom:8px!important}.hero .subtitle,.hero .prof{font-size:10px!important}.hero .tags{margin-top:10px!important}.toc-card{margin:12px auto 0!important;padding:12px 20px!important}.content{padding:14px 22px 28px!important}.section{break-inside:avoid;margin-bottom:18px!important}.sec-head{padding:8px 16px!important}.section-body{padding:12px 16px!important}.minute{padding:10px 16px 14px!important;margin-bottom:18px!important}.remember{padding:10px 16px 14px!important;margin-top:18px!important}.to-top{display:none!important}}';doc.head.appendChild(style)}catch(e){}}
...
@media print{@page{size:auto;margin:10mm}body,*{-webkit-print-color-adjust:exact;print-color-adjust:exact}.hero{padding:18px 24px}.hero h1{font-size:24px}.hero .top{font-size:8px;margin-bottom:8px}.hero .subtitle,.hero .prof{font-size:10px}.hero .tags{margin-top:10px}.toc-card{margin:12px auto 0;padding:12px 20px}.content{padding:14px 22px 28px}.section{break-inside:avoid;margin-bottom:18px}.sec-head{padding:8px 16px}.section-body{padding:12px 16px}.minute{padding:10px 16px 14px;margin-bottom:18px}.remember{padding:10px 16px 14px;margin-top:18px}.to-top{display:none}}
...
O site tem seu próprio botão de "Salvar PDF" que abre uma janela separada só para imprimir. Inclua obrigatoriamente este bloco exato no final do seu <style>, sem alterações: @media print{@page{size:auto;margin:10mm}body,*{-webkit-print-color-adjust:exact;print-color-adjust:exact}.hero{padding:18px 24px}.hero h1{font-size:24px}.hero .top{font-size:8px;margin-bottom:8px}.hero .subtitle,.hero .prof{font-size:10px}.hero .tags{margin-top:10px}.toc-card{margin:12px auto 0;padding:12px 20px}.content{padding:14px 22px 28px}.section{break-inside:avoid;margin-bottom:18px}.sec-head{padding:8px 16px}.section-body{padding:12px 16px}.minute{padding:10px 16px 14px;margin-bottom:18px}.remember{padding:10px 16px 14px;margin-top:18px}.to-top{display:none}}
— Por que cada regra existe: print-color-adjust:exact preserva fundos coloridos (hero gradient, cabeçalhos, caixas). .hero h1{font-size:24px} fixa o título em 18pt no PDF (sem isso o browser resolve o clamp() com a largura da janela de preview, gerando texto gigante de 56pt+). Os paddings reduzidos tornam o PDF mais compacto e próximo de um documento impresso. .section{break-inside:avoid} evita card cortado no meio da página.
